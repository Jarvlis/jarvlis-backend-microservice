package com.jarvlis.jarojbackendquestionservice.controller;

import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.google.gson.Gson;
import com.jarvlis.jarojbackendcommon.annotation.AuthCheck;
import com.jarvlis.jarojbackendcommon.common.BaseResponse;
import com.jarvlis.jarojbackendcommon.common.DeleteRequest;
import com.jarvlis.jarojbackendcommon.common.ErrorCode;
import com.jarvlis.jarojbackendcommon.common.ResultUtils;
import com.jarvlis.jarojbackendcommon.constant.UserConstant;
import com.jarvlis.jarojbackendcommon.exception.BusinessException;
import com.jarvlis.jarojbackendcommon.exception.ThrowUtils;
import com.jarvlis.jarojbackendmodel.dto.quesitonsubmit.QuestionSubmitAddRequest;
import com.jarvlis.jarojbackendmodel.dto.quesitonsubmit.QuestionSubmitQueryRequest;
import com.jarvlis.jarojbackendmodel.dto.question.*;
...
import com.jarvlis.jarojbackendmodel.vo.QuestionSubmitVO;
...
public class QuestionController {
    ...
    public BaseResponse<Boolean> updateQuestion(@RequestBody QuestionUpdateRequest questionUpdateRequest) {
        ...
        JudgeConfig judgeConfigs = questionUpdateRequest.getJudgeConfig();
        if (judgeConfigs != null) {
            question.setJudgeConfig(GSON.toJson(judgeConfigs));
        }
        // 参数校验
    ...
    public BaseResponse<Boolean> editQuestion(@RequestBody QuestionEditRequest questionEditRequest, HttpServletRequest request) {
        ...
        JudgeConfig judgeConfigs = questionEditRequest.getJudgeConfig();
        if (judgeConfigs != null) {
            question.setJudgeConfig(GSON.toJson(judgeConfigs));
        }
        // 参数校验
    ...
    public BaseResponse<Long> doQustionSubmit(@RequestBody QuestionSubmitAddRequest questionSubmitAddRequest,
                                              HttpServletRequest request) {
